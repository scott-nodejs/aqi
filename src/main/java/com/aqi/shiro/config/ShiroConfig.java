...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager,UserAuthFilter userAuthFilter) {
        ...
        filterMap.put("/phone/login","anon");
        ...
        filterMap.put("/api/**","userAuth");
        filterMap.put("/client/api/comment/add","userAuth");
        filterMap.put("/admin/**","adminAuth");
        filterMap.put("/**", "anon");
     ...
     */
    @Bean
    public DefaultWebSessionManager getDefaultWebSessionManager(EhCacheManager cacheManager, ShiroProjectProperties properties, RedisSessionDAO redisSessionDAO) {
